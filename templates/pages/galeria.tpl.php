...
catch(PDOException $e)
{
	$nez=false;
	?>
	<p id="k">Nem vagy bejelenkezve</p><?php
...
<body>
    <div id="galeria">
    <h5><strong>Galéria</strong></h5><br>
...
<div class="desc" >			
	...
	<br><br>
	   <h4><center><strong>Feltöltés a galériába:</strong></h4>
	   <br>
...
?>
<?php if($ne==true){ ?>
<h3><center>Be vagy jelenkezve így tudsz a galériába képet feltölteni.</h3><br>
<?php
}
else
{
?>
<h4><center>Nem vagy bejenkezve így nem tudsz a galériába képet feltölteni.</h4><br>
<?php }	?>

    <form method="post"
                enctype="multipart/form-data">
				
        <p id="k"><label><strong>Kép:</strong> </label> <input type="file" name="elso" required><br><p>
       <br>
